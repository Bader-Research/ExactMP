...
void enqueueAddOrdTaxa(int , THREADED); 
...
int    maskStateInPos(int , int , THREADED);
void   freeTree(struct subTask *, THREADED);
void   storeTree(struct subTask *, THREADED);
void   pushTask(struct taskNode *, THREADED);
void   enqueueTask(struct subTask *, THREADED);
int    dequeueTaxaQ(struct taskNode *, THREADED);
void   printTree(struct subTask *, int, THREADED);
void   freeStackNode(struct taskNode *, THREADED);
int    purdomsLowerBnd(struct taskNode *, THREADED);
void   pushBestCostNode(struct subTask *, THREADED);
void   subTaskPrint(struct subTask *, int, THREADED);
void   printTaxaStatus (struct taskNode *, THREADED);
struct taskNode *copyTaxaQ(struct taskNode *, THREADED);
void   computeCost(struct subTask *, int, int, THREADED);
void   setParentChildIndices (struct subTask *, THREADED);
void convert(int *, int , int **, int , int, int *, THREADED);
void   printBestSolutions(int, int, int, int, FILE *, THREADED);
...
struct subTask *genNextTask(struct subTask *, struct subTask *, int , int , THREADED);
struct subTask *genNextEckDayTask(struct subTask *, struct subTask *, int , int , THREADED);
void performFitchOp(struct subTaskArrayNode *, struct subTaskArrayNode *, struct subTaskArrayNode *, THREADED);
