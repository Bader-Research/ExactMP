...
struct subTask *genNextTask(struct subTask *currTask, struct subTask *nextTask, int taxa, int pos, THREADED) {
...
void setParentChildIndices (struct subTask *sourceSubTask, THREADED) {
  int arrIndx;
  int indx;
