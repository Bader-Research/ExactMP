...
* Authors: Vaddadi Chandu and David Bader                                     *
******************************************************************************/
#include "header.h"

void printBestSolutions(int bc, int chk, int prn, int ibc, FILE *fp, THREADED){
...
void pushBestCostNode(struct subTask *addBCNode, THREADED) {
...
void pushTask(struct taskNode *srcTNode, THREADED) {
	struct taskStack *temp;
	if (taskSTop==NULL) {
...
void freeStackNode(struct taskNode *srcNode, THREADED) {
   struct taxaQ *temp;
   freeTree(srcNode->partialTask, TH);
...
int dequeueTaxaQ(struct taskNode *srcNode, THREADED) {
   struct taxaQ *temp;
   int retVal;
...
struct taskNode *copyTaxaQ(struct taskNode *srcNode, THREADED) {
...
void enqueueAddOrdTaxa(int taxa, THREADED) {
  struct taxaQ *temp_node;
...
void deleteTaxa(int taxa, THREADED) {
...
void freeTree(struct subTask *sourceTree, THREADED) {
   int i;
