...
int **genIstOptSubTask(int **currSubTask) {
  int indx=0, length,
...
void genTaskLeft(int **currTask,int **nextTask,int taxa,int pos) {

   int ctsl, ctsr, ntsl, ntsr,
       ctr=0, sp=-1, hin=0,
...
void genTaskRight(int **currTask,int **nextTask,int taxa,int pos) {
